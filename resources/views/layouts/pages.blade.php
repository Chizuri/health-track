...
<head>
    ...
    <title>{{ config('app.name', 'Health-Track') }}</title>
    ...
    <!-- Full Calendar -->
    <link rel="stylesheet" href="{{ URL::asset('css/fullcalendar/fullcalendar.css') }}" />
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Citas M&eacute;dicas</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
